namespace BBBankAPI.Middleawares
{
    public class LoggingMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly ILogger<LoggingMiddleware> _logger;
        // Midleware impletaion must include 
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            try
            {
                // this line will be executed when it enters the custom middleware and by that time it has the infromation about the method its trying to excute using the context.
